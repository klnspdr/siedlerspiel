...
$sql="UPDATE inventory, groups SET `$sqlItem`=`$sqlItem`+1, groups.max_hp=groups.max_hp+:plusMaxHP, groups.hp=  LEAST(hp+:plusHP, max_hp+:plusMaxHP), groups.score=groups.score+:score WHERE inventory.groupId=:groupId AND groups.groupId=:groupId;";
